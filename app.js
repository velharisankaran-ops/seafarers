...
const SUPABASE_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdpcmZzdW1jcWttb2t2cWpvenJtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njk1ODA5OTgsImV4cCI6MjA4NTE1Njk5OH0.Tzyry76B31KEdXupQ_TUt7TAMVhO-2DZd-xNd1-wsUc";
  ...
  data.forEach(s => {
    container.innerHTML += `
      <div style="border:1px solid #ccc;padding:12px;margin-bottom:10px;border-radius:6px;">
        ...
        <p><b>Experience:</b> ${s.total_experience_years || 0} years</p>
